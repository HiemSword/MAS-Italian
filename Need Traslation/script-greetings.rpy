...
label monikaroom_greeting_ear_narration:
    ...
    call spaceroom (dissolve_all=True, scene_change=True) from _call_spaceroom_34
...
label monikaroom_greeting_opendoor_seen_partone:
    ...
    call spaceroom (start_bg="bedroom", hide_monika=True, scene_change=True, dissolve_all=True) from _call_spaceroom_36
    pause 0.2
...
label monikaroom_greeting_opendoor_post2:
    ...
    m 1dsc "...{w=1.5}{nw}"
    call spaceroom (hide_monika=True, scene_change=True) from _call_spaceroom_37
...
label monikaroom_greeting_opendoor:
    ...
    call spaceroom (start_bg="bedroom", hide_monika=True, dissolve_all=True) from _call_spaceroom_38
...
label monikaroom_greeting_knock:
    ...
    menu:
        "It's me.":
            ...
            call spaceroom (hide_monika=True, dissolve_all=True, scene_change=True) from _call_spaceroom_39
    jump monikaroom_greeting_post
...
label monikaroom_greeting_post:
    if mas_isMoniNormal(higher=True):
        ...
        $ is_sitting = True
        show monika 2efc zorder MAS_MONIKA_Z at ls32
...
label greeting_hairdown:
    ...
    call spaceroom (dissolve_all=True, scene_change=True, force_exp='monika 1eua_static') from _call_spaceroom_40
...
label greeting_ourreality:
    ...
    if mas_current_weather != mas_weather_def:
        call mas_change_weather (mas_weather_def) from _call_mas_change_weather_5
...
default -5 persistent._mas_bday_date_count = 0
default -5 persistent._mas_bday_date_affection_lost = 0
default -5 persistent._mas_bday_date_affection_gained = 0
...
label greeting_returned_home_bday:
    ...
    if time_out <= five_minutes:
        ...
        call greeting_returned_home_lessthan5mins from _call_greeting_returned_home_lessthan5mins_1
        ...
        if is_first_date():
            ...
            $ lose_and_track_affection(1)
            call greeting_returned_home_bday_short_sub_short_total from _call_greeting_returned_home_bday_short_sub_short_total
            ...
            $ cap_gain_aff(4)
            call greeting_returned_home_bday_short_sub_normal_total from _call_greeting_returned_home_bday_short_sub_normal_total
        else:
            ...
            $ cap_gain_aff(6)
            call greeting_returned_home_bday_short_sub_long_total from _call_greeting_returned_home_bday_short_sub_long_total
        ...
        if is_first_date():
            ...
            $ cap_gain_aff(1)
            call greeting_returned_home_bday_short_sub_short_total from _call_greeting_returned_home_bday_short_sub_short_total_1
            ...
            $ cap_gain_aff(4.5)
            call greeting_returned_home_bday_short_sub_normal_total from _call_greeting_returned_home_bday_short_sub_normal_total_1
        else:
            ...
            $ cap_gain_aff(6.5)
            call greeting_returned_home_bday_short_sub_long_total from _call_greeting_returned_home_bday_short_sub_long_total_1
        ...
        if is_first_date():
            $ cap_gain_aff(10)
            call greeting_returned_home_bday_normal_first from _call_greeting_returned_home_bday_normal_first

        elif is_normal_date(total_time_out):
            $ cap_gain_aff(10)
            call greeting_returned_home_bday_normal_sub_normal_total from _call_greeting_returned_home_bday_normal_sub_normal_total
        else:



            $ cap_gain_aff(12)
            call greeting_returned_home_bday_normal_sub_long_total from _call_greeting_returned_home_bday_normal_sub_long_total
        ...
        if is_first_date():
            $ cap_gain_aff(20)
            call greeting_returned_home_bday_normal_first from _call_greeting_returned_home_bday_normal_first_1

        elif is_normal_date(total_time_out):
            $ cap_gain_aff(20)
            call greeting_returned_home_bday_normal_sub_normal_total from _call_greeting_returned_home_bday_normal_sub_normal_total_1
        else:


            $ cap_gain_aff(24)
            call greeting_returned_home_bday_normal_sub_long_total from _call_greeting_returned_home_bday_normal_sub_long_total_1
        ...
        if is_first_date():
            ...
            $ cap_gain_aff(50)
            call greeting_returned_home_bday_long_sub from _call_greeting_returned_home_bday_long_sub
...
label ch30_reload_delegate:
    ...
    if persistent.monika_reload >= 4:
        ...
        call expression reload_label from _call_expression_7
