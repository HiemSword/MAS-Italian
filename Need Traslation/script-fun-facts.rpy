...
label mas_bad_facts_1:
    ...
    call mas_bad_facts_end from _call_mas_bad_facts_end_1
    return
...
label mas_bad_facts_2:
    ...
    call mas_bad_facts_end from _call_mas_bad_facts_end_2
    return
...
label mas_bad_facts_3:
    ...
    call mas_bad_facts_end from _call_mas_bad_facts_end_3
    return
...
label mas_bad_facts_4:
    ...
    call mas_bad_facts_end from _call_mas_bad_facts_end_4
    return
