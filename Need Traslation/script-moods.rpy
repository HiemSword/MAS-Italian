...
default -5 persistent._mas_mood_bday_last = None
default -5 persistent._mas_mood_bday_lies = 0
default -5 persistent._mas_mood_bday_locked = False
...
label mas_mood_yearolder:
    ...
    menu:
        ...
        "No.":
            ...
            call mas_bday_player_bday_select from _call_mas_bday_player_bday_select
            python:
        ...
        "It's not.":
            ...
            menu:
                ...
                "No.":
                    ...
                    m "Then..."
                    call mas_bday_player_bday_select from _call_mas_bday_player_bday_select_1
                    python:
                        store.mas_calendar.removeRepeatable_d(
                            "player-bday",
                            selected_date
