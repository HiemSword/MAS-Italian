...
default -5 persistent._mas_player_bookmarked = {}

default -5 persistent._mas_player_derandomed = {}
...
default -5 persistent._mas_likes_rain = None
            ...
            "I hate the rain.":
                ...
                if mas_is_raining:
                    if mas_isWinter():
                        ...
                        call mas_change_weather (mas_weather_snow) from _call_mas_change_weather_3
                    else:

                        call mas_change_weather (mas_weather_def, by_user=False) from _call_mas_change_weather_4
...
label monika_rain_stop:
    ...
    call spaceroom (scene_change=True) from _call_spaceroom_22
...
label monika_love:
    if mas_isMoniBroken():
        ...
        if persistent._mas_monika_lovecounter == 0:
            ...
            call monika_lovecounter_aff from _call_monika_lovecounter_aff
            return
            ...
            call monika_lovecounter_aff from _call_monika_lovecounter_aff_1
            return
        else:
    ...
    call monika_lovecounter_aff from _call_monika_lovecounter_aff_2
    return
...
label monika_aware:
    ...
    call showpoem (poem=poem_m21, music=False) from _call_showpoem_21
...
label monika_morning:
    ...
    if 4 <= current_time <= 11:
        ...
        m "Well, maybe not as funny as me~"
    return
...
default -5 persistent._mas_penname = ""
init python:
...
default -5 persistent._mas_monika_breakup = 0
        ...
        if mas_isMoniUpset(lower=True):
            ...
            menu:
                ...
                "Of course not.":
                    ...
                    call monika_breakup_logic from _call_monika_breakup_logic
                    return "love"

    call monika_breakup_logic from _call_monika_breakup_logic_1
    return
...
label monika_pygmalion:
    ...
    call monika_kissing_motion (duration=0.5, initial_exp="6hubfa", fade_duration=0.5) from _call_monika_kissing_motion_10
    m 6hubfa "..."
...
label monika_scary_stories:
    call mas_stories_start (scary=True) from _call_mas_stories_start
    return
...
label monika_dating_startdate_confirm(first_sesh_raw):
    ...
    if not selected_date or selected_date.date() == first_sesh_raw.date():
        ...
        label _call_mas_start_calendar_select_date_1.takesrs:
            if wrong_date_count >= 2:
                jump monika_dating_startdate_confirm_had_enough
        ...
        jump _call_mas_start_calendar_select_date_1.takesrs
        ...
        menu:
            ...
            "That was a misclick!":
                ...
                label _call_mas_start_calendar_select_date_1.misclick:
                    m 2dfu "[player]!"
